...
export default class ScanVisorDesktop extends React.Component<Props> {
    ...
    render() {
        const { leftPanel, rightPanel, centerPanel, descriptionPanel } = this.props;
        return (
            <>
                <ScanVisorDesktopSVG
                    ref={this.svgRef}
...
// TODO mobile-version of the scan visor
